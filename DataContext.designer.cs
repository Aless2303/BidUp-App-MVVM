...
namespace BidUp_App
{
    ...
    partial void OnAuctionStatusChanging(string value);
    partial void OnAuctionStatusChanged();
    #endregion
		...
		public int SellerID
		{
			...
			set
			{
				...
				{
					if ((this._User1.HasLoadedOrAssignedValue || this._User2.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AuctionStatus", DbType="NVarChar(20) NOT NULL", CanBeNull=false)]
		public string AuctionStatus
		{
			...
			set
			{
				...
				{
					this.OnAuctionStatusChanging(value);
					this.SendPropertyChanging();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Auction2", Storage="_User2", ThisKey="SellerID", OtherKey="UserID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public User User2
		{
			get
			{
			...
			set
			{
							...
							|| (this._User2.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Auctions2.Remove(this);
					}
					this._User2.Entity = value;
					if ((value != null))
					{
						value.Auctions2.Add(this);
						this._SellerID = value.UserID;
					}
					else
					{
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Auction> _Auctions2;
    ...
    partial void OnCreatedAtChanged();
		...
		public User()
		{
			...
			this._Auctions2 = new EntitySet<Auction>(new Action<Auction>(this.attach_Auctions2), new Action<Auction>(this.detach_Auctions2));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Auction2", Storage="_Auctions2", ThisKey="UserID", OtherKey="SellerID")]
		public EntitySet<Auction> Auctions2
		{
			get
			{
				return this._Auctions2;
			}
			set
			{
				this._Auctions2.Assign(value);
			}
		}
		...
		private void attach_Auctions2(Auction entity)
		{
			this.SendPropertyChanging();
			entity.User2 = this;
		}
		
		private void detach_Auctions2(Auction entity)
		{
			this.SendPropertyChanging();
			entity.User2 = null;
		}
